...
export class LambdaToSns extends Construct {
    ...
    constructor(scope: Construct, id: string, props: LambdaToSnsProps) {
        ...
        this.fn.addEnvironment('SNS_TOPIC_NAME', this.topic.topicName);
        this.fn.addEnvironment('SNS_TOPIC_ARN', this.topic.topicArn);

        // Add publishing permissions to the function
        this.topic.grantPublish(this.fn.grantPrincipal);
    }
