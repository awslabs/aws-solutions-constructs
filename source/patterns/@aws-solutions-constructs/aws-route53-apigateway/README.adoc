...
image::architecture.png["Diagram showing the Route53 ALIAS record in an existing hosted zone and API Gateway api created by the construct",scaledwidth=100%]
