...
https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-resource-pipes-pipe.html#cfn-pipes-pipe-logconfiguration[here])
that can be overriden by populating those values in
...
|pipeLogProps? |https://docs.aws.amazon.com/cdk/api/v2/docs/aws-cdk-lib.aws_logs.LogGroupProps.html[`logs.LogGroupProps`] |
Default behavior is for this construct to create a new CloudWatch Logs log group for the pipe.
