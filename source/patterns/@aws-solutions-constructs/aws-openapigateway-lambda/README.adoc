...
Logo] Python
|`aws++_++solutions++_++constructs.aws++_++openapigateway++_++lambda`
...
(`++<++repository++_++root++>++/source/patterns/@aws-solutions-constructs/aws-openapigateway-lambda/test`)
...
|apiDefinitionAsset?
|https://docs.aws.amazon.com/cdk/api/v2/docs/aws-cdk-lib.aws_s3_assets.Asset.html[`aws++_++s3++_++assets.Asset`]
