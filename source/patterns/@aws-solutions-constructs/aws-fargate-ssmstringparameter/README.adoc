...
image::aws-fargate-ssmstringparameter.png["Diagram showing the Fargate service, SSM string paramter and IAM role created by the construct",scaledwidth=100%]
