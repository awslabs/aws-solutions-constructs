...
image::architecture.png["Diagram showing the Lambda function, SQS queue and dlq, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
