...
image::architecture.png["Diagram showing the KInesis data firehose, S3 buckets, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
