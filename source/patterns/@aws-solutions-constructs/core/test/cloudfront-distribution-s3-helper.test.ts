...
test('check bucket policy metadata', () => {
  ...
  const buildSourceBucketResponse = buildS3Bucket(stack, {});
  CloudFrontDistributionForS3(stack, buildSourceBucketResponse.bucket);
...
test('test cloudfront with no security headers ', () => {
  ...
  CloudFrontDistributionForS3(stack, buildSourceBucketResponse.bucket, {}, false);
...
test('test cloudfront override cloudfront logging bucket ', () => {
  ...
  CloudFrontDistributionForS3(stack, buildSourceBucketResponse.bucket, myprops);
...
test('test cloudfront override properties', () => {
  ...
  const props: cloudfront.DistributionProps = {
    defaultBehavior: {
      origin: new origins.S3Origin(buildSourceBucketResponse.bucket, { originPath: '/testPath' }),
  ...
  CloudFrontDistributionForS3(stack, buildSourceBucketResponse.bucket, props);
