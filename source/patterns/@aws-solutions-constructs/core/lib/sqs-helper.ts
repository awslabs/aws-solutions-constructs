...
function DetermineAppropriateMasterKey(scope: Construct, id: string, props: BuildQueueProps): kms.IKey | undefined {
  if (props.queueProps?.encryptionMasterKey) {
    ...
    return buildEncryptionKey(scope, id, props.encryptionKeyProps);
  }
  return undefined;
}
