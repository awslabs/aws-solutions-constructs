...
Logo] Python
|`aws++_++solutions++_++constructs.aws++_++lambda++_++kinesis++_++stream`
...
Data Stream name value. Default: KINESIS++_++DATASTREAM++_++NAME
|===
...
* Sets an Environment Variable named KINESIS++_++DATASTREAM++_++NAME
