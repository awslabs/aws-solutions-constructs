...
|secretEnvironmentVariableName?|`string`|Optional name for the Lambda funcction environment variable containing the srn of the secret. Default is SECRET_ARN. |
