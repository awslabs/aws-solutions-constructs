...
import { generateIntegStackName, suppressCustomHandlerCfnNagWarnings, CreateShortUniqueTestName, SetConsistentFeatureFlags } from '@aws-solutions-constructs/core';
...
stack.templateOptions.description = 'Integration Test with new VPC, Service and OpenSearch Service domain';
