...
|Optional - user provided properties to override the default properties for the SNS topic. Providing both this and `existingNotificationTopicObj` is an error. Only valid when asyncJobs is true.
