...
Logo] Python
|`aws++_++solutions++_++constructs.aws++_++constructs++_++factories`
...
** cfn++_++nag suppression of access logging finding (not logging access
...
|logGroup?
|++[]++`logs.LogGroup`++]++(https://docs.aws.amazon.com/cdk/api/v2/docs/aws-cdk-lib.aws++_++logs.LogGroup.html)
...
|logGroup
|++[]++`logs.LogGroupProps`++]++(https://docs.aws.amazon.com/cdk/api/v2/docs/aws-cdk-lib.aws++_++logs.LogGroupProps.html)
|
...
.Architecture Diagram
image::sf-architecture.png[Architecture Diagram]
...
.Architecture Diagram
image::sqs-architecture.png[Architecture Diagram]
