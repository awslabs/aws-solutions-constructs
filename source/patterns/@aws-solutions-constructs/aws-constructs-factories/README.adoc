...
|===
|*Name* |*Type* |*Description*
|vpcProps? |ec2.VpcProps {vbar} any|Optional user provided props to override
the default props for the vpc.

|subnetTypes? |ec2.SubnetType[] | Optional - Determines the various groups of subnets
...
CDK default of 17 (up to 32763 addresses).

|endPoints? |ServiceEndpointTypes[] |Optional - A list of all VPC service endpoints
to launch in the VPC. They are specified using an enum defined by this factory.  @default - None
...
|===
|*Name* |*Type* |*Description*
|vpc |ec2.Vpc |The vpc created by the factory.
