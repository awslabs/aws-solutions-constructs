...
image::architecture.png["Diagram showing the Kinesis data stream, Glue job, S3 bucket, storage destinations and IAM role created by the construct",scaledwidth=100%]
