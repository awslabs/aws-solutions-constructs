...
| etlCodeAsset?       | [s3assets.Asset](https://docs.aws.amazon.com/cdk/api/v2/docs/aws-cdk-lib.aws_s3-assets.Asset.html)                               | User provided instance of the Asset class that represents the ETL code on the local filesytem                    |
