...
image::aws-eventbridge-kinesisfirehose-s3.png["Diagram showing the EventBridge rule, IAM roles, Kinesis data firehose, S3 buckets, CloudWatch log group and IAM roles created by the construct",scaledwidth=100%]
