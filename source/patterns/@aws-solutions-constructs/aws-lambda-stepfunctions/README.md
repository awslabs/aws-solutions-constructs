...
|stateMachineEnvironmentVariableName?|`string`|Optional name for the Lambda function environment variable containing the ARN of the state machine. Default: STATE_MACHINE_ARN |
