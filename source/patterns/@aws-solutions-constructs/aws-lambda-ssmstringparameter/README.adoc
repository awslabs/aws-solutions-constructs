...
image::architecture.png["Diagram showing the Lambda function, SSM string parameter, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
