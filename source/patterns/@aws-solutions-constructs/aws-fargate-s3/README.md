...
|bucketArnEnvironmentVariableName?|string|Optional name for the container environment variable containing the bucket ARN.|
|bucketEnvironmentVariableName?|string|Optional Optional name for the container environment variable containing the bucket name.|
