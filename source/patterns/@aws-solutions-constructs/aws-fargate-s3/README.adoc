...
|Optional - existing instance of S3 Bucket. If this is provided, then also providing bucketProps
results in an error.
...
image::aws-fargate-s3.png["Diagram showing the Fargate service, S3 bucket and IAM role created by the construct",scaledwidth=100%]
