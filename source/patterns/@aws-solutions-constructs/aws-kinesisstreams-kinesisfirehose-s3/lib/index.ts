...
import { addL2CfnGuardSuppressRules, overrideProps } from '@aws-solutions-constructs/core';
...
export class KinesisStreamsToKinesisFirehoseToS3 extends Construct {
  ...
  constructor(scope: Construct, id: string, props: KinesisStreamsToKinesisFirehoseToS3Props) {
    ...
    addL2CfnGuardSuppressRules(this.kinesisStreamRole, ["IAM_NO_INLINE_POLICY_CHECK"]);
