...
image::architecture.png["Diagram showing the Lambda function, Elasticsearch domain, Cognito domain, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
