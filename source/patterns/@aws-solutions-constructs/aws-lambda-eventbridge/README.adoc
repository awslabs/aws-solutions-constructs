...
image::aws-lambda-eventbridge.png["Diagram showing the Lambda function, CloudWatch log group, EventBridge bus and IAM role created by the construct",scaledwidth=100%]
