...
|eventBusEnvironmentVariableName?|`string`|Optional name for the Lambda function environment variable containing the name of the Event bus. Default: EVENTBUS_NAME |
