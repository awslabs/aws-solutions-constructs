...
image::architecture.png["Diagram showing the S3 bucket, EventBridge rule, Step Functions state machine, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
