...
|topicArnEnvironmentVariableName?|`string`|Optional name for the Lambda funcction environment variable containing the arn of the Topic.|
|topicNameEnvironmentVariableName?|`string`|Optional name for the Lambda funcction environment variable containing the name of the topic.|
