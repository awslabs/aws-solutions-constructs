...
stack.templateOptions.description = 'Integration Test for aws-lambda-transcribe with same bucket';

// Definitions
new LambdaToTranscribe(stack, 'test-lambda-transcribe-same-bucket', {
  lambdaFunctionProps: {
