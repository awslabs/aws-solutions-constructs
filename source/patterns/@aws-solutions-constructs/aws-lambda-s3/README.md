...
|bucketEnvironmentVariableName?|`string`|Optional name for the Lambda function environment variable containing the name of the bucket. Default: S3_BUCKET_NAME |
