...
image::imagesws-dynamodbstreams-lambda-elasticsearch-kibana.png["Diagram showing data flow between AWS services including ElasticsSearch, Cognito, DynamoDB, Lambda, CloudWatch and an IAM Role",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-dynamodbstreams-lambda-elasticsearch-kibana[-solutions-constructsaws-dynamodbstreams-lambda-elasticsearch-kibana]
|===
