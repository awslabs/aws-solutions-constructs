...
image::imagesws-route53-alb.png["Diagram showing the Route53 ALIAS record in an existing hosted zone and Application Load Balancer created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-route53-alb[-solutions-constructsaws-route53-alb]
|===
