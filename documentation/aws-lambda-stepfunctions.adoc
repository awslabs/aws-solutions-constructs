...
image::imagesws-lambda-stepfunctions.png["Diagram showing the Lambda function, Step Functions state machine and IAM role created by the construct",scaledwidth=100%]
