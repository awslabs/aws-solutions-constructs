...
image::imagesws-sns-lambda.png["Diagram showing the SNS topic, Lambda Function, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-sns-lambda[-solutions-constructsaws-sns-lambda]
|===
