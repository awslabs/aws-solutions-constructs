...
image::imagesws-kinesisfirehose-s3.png["Diagram showing the KInesis data firehose, S3 buckets, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-kinesisfirehose-s3[-solutions-constructsaws-kinesisfirehose-s3]
|===
