...
image::imagesws-lambda-kinesisfirehose.png["Diagram showing the Lambda function, Kinesis firehose and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-lambda-kinesisfirehose[-solutions-constructsaws-lambda-kinesisfirehose]
|===
