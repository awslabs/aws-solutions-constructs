...
While Solutions Constructs does not publish code for the Lambda function to call Firehose, here is an example of calling Firehose: https://github.com/awsdocs/aws-doc-sdk-examples/blob/main/python/example_code/firehose/scenarios/firehose-put-actions/firehose.py['example']. (this example is in Python, but examples in other languages can also be found at this site)
