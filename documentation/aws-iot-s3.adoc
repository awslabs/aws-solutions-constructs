...
image::imagesws-iot-s3.png["Diagram showing the IoT rule, S3 buckets and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-iot-s3[-solutions-constructsaws-iot-s3]
|===
