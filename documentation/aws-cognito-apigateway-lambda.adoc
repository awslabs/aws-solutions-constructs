...
image::imagesws-cognito-apigateway-lambda.png["Diagram showing data flow between AWS services including Cognito, API Gateway, Lambda, CloudWatch and IAM Roles",scaledwidth=100%]
