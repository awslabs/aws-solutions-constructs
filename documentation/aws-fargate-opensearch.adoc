...
image::imagesws-fargate-opensearch.png["Diagram showing the Fargate service, OpenSearch domain, Cognito domain and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-fargate-opensearch[-solutions-constructsaws-fargate-opensearch]
|===
