...
image::imagesws-fargate-sqs.png["Diagram showing the Fargate service, SQS queue and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-fargate-sqs[-solutions-constructsaws-fargate-sqs]
|===
