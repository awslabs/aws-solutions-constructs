...
include::aws-lambda-comprehend.adoc[leveloffset=+1]
...
include::aws-lambda-polly.adoc[leveloffset=+1]
...
include::aws-lambda-textract.adoc[leveloffset=+1]


include::aws-lambda-transcribe.adoc[leveloffset=+1]


include::aws-lambda-translate.adoc[leveloffset=+1]
