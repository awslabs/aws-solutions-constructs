...
image::imagesws-s3-sns.png["Diagram showing the S3 bucket and SNS topic created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-s3-sns[-solutions-constructsaws-s3-sns]
|===
