...
image::imagesws-eventbridge-lambda.png["Diagram showing the EventBridge rule, Lambda function, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-eventbridge-lambda[-solutions-constructsaws-eventbridge-lambda]
|===
