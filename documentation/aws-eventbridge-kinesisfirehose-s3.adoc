...
image::imagesws-eventbridge-kinesisfirehose-s3.png["Diagram showing the EventBridge rule, IAM roles, Kinesis data firehose, S3 buckets, CloudWatch log group and IAM roles created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-eventbridge-kinesisfirehose-s3[-solutions-constructsaws-eventbridge-kinesisfirehose-s3]
|===
