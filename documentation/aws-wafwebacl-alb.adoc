...
image::imagesws-wafwebacl-alb.png["Diagram showing the WAF ACL, Application Load Balancer, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-wafwebacl-alb[-solutions-constructsaws-wafwebacl-alb]
|===
