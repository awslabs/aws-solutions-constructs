...
image::imagesws-kinesisstreams-kinesisfirehose-s3.png["Diagram showing the Kinesis data stream, Kinesis data firehose, CloudWatch log group, S3 buckets and IAM role created by the construct",scaledwidth=100%]
