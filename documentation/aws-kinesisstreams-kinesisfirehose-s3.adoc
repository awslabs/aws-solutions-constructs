...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-kinesisstreams-kinesisfirehose-s3[-solutions-constructsaws-kinesisstreams-kinesisfirehose-s3]
|===
