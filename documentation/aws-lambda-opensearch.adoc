...
image::imagesws-lambda-opensearch.png["Diagram showing the Lambda function, OpenSearch domain, Cognito domain, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-lambda-opensearch[-solutions-constructsaws-lambda-opensearch]
|===
