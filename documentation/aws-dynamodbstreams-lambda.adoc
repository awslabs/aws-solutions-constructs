...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-dynamodbstreams-lambda[-solutions-constructsaws-dynamodbstreams-lambda]
|===
