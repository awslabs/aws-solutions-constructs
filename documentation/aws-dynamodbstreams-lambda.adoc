...
image::imagesws-dynamodbstreams-lambda.png["Diagram showing data flow between AWS services including DynamoDB, Lambda, CloudWatch and an IAM Role",scaledwidth=100%]
