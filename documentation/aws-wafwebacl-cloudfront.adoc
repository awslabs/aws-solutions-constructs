...
image::imagesws-wafwebacl-cloudfront.png["Diagram showing the WAF ACL, CloudFront distribution, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-wafwebacl-cloudfront[-solutions-constructsaws-wafwebacl-cloudfront]
|===
