...
image::imagesws-iot-sqs.png["Diagram showing the IoT rule, SQS queue and dlg, and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-iot-sqs[-solutions-constructsaws-iot-sqs]
|===
