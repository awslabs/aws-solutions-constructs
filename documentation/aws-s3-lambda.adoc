...
image::imagesws-s3-lambda.png["Diagram showing the S3 bucket, Lambda function, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
