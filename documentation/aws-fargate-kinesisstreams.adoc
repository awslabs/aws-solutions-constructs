...
image::imagesws-fargate-kinesisstreams.png["Diagram showing the Fargate service, Kinesis data stream and CloudWatch alarms created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-fargate-kinesisstreams[-solutions-constructsaws-fargate-kinesisstreams]
|===
