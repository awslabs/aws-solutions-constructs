...
image::imagesws-fargate-ssmstringparameter.png["Diagram showing the Fargate service, SSM string paramter and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-fargate-ssmstringparameter[-solutions-constructsaws-fargate-ssmstringparameter]
|===
