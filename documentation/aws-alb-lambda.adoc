...
image::imagesws-alb-lambda.png["AWS architecture diagram showing Application Load Balancer, Lambda function, S3, and CloudWatch interactions.",scaledwidth=100%]
