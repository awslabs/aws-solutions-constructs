...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-alb-lambda[-solutions-constructsaws-alb-lambda]
|===
