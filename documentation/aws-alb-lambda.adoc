...
and existingLoadBalancer causes an error. This cannot specify a VPC, it will
...
architecture. Providing both this and loadBalancerProps causes an error. The
