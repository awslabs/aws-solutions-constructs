...
image::imagesws-apigateway-kinesisstreams.png["Diagram showing data flow between cloud search, code analysis, and network components.",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-apigateway-kinesisstreams[-solutions-constructsaws-apigateway-kinesisstreams]
|===
