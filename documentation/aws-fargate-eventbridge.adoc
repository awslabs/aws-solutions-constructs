...
image::imagesws-fargate-eventbridge.png["Diagram showing the Fargate service, EventBridge bus and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-fargate-eventbridge[-solutions-constructsaws-fargate-eventbridge]
|===
