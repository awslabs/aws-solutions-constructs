...
image::imagesws-eventbridge-kinesisstreams.png["Diagram showing the EventBridge rule, Kinesis data stream and IAM role created by the construct",scaledwidth=100%]
