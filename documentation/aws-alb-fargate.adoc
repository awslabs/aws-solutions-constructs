...
// |image::images/GitHub-Mark-32px.png["Github logo",scaledwidth=100%]
// |
// |https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-apigateway-iot[@aws-solutions-constructs/aws-apigateway-iot]
// |===
...
[cols="1,1", options="header"]
|===
2+| To view the code for this pattern, create/view issues and pull requests, and more:
|image:https://docs.aws.amazon.com/cdk/api/latest/img/typescript32.png
| https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-apigateway-iot[@aws-solutions-constructs/aws-apigateway-iot]
|===
