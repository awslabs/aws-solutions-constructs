...
image::imagesws-alb-fargate.png["Application Load Balancer directing traffic to AWS Fargate and Amazon S3 services.",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-alb-fargate[-solutions-constructsaws-alb-fargate]
|===
