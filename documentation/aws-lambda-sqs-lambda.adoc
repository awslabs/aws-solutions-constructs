...
image::imagesws-lambda-sqs-lambda.png["Diagram showing the Lambda functions, SQS queue and dlq, CloudWatch log groups and IAM roles created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-lambda-sqs-lambda[-solutions-constructsaws-lambda-sqs-lambda]
|===
