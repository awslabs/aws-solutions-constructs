...
image::imagesws-fargate-s3.png["Diagram showing the Fargate service, S3 bucket and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-fargate-s3[-solutions-constructsaws-fargate-s3]
|===
