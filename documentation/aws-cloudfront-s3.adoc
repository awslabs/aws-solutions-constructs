...
image::images/aws-cloudfront-s3.png["Diagram showing data flow between AWS services including CLoudFront, S3, and an Origin Access Control",scaledwidth=100%]

Go to the https://github.com/awslabs/aws-solutions-constructs/tree/main/source/patterns/%40aws-solutions-constructs/aws-cloudfront-s3[Github repo] for this pattern to view the code, read/create issues and pull requests and more.
