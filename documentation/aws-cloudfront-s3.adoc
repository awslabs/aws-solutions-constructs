...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-cloudfront-s3[-solutions-constructsaws-cloudfront-s3]
|===
