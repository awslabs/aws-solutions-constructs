...
image::imagesws-iot-lambda-dynamodb.png["Diagram showing the IoT rule, Lambda function, DynamoDB table, log group and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-iot-lambda-dynamodb[-solutions-constructsaws-iot-lambda-dynamodb]
|===
