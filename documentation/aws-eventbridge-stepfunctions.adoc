...
image::imagesws-eventbridge-stepfunctions.png["Diagram showing the CloudWatch event rule, State Machine, log group and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-eventbridge-stepfunctions[-solutions-constructsaws-eventbridge-stepfunctions]
|===
