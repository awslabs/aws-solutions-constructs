...
image::imagesws-wafwebacl-appsync.png["Diagram showing the WAF ACL, AppSync api, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-wafwebacl-appsync[-solutions-constructsaws-wafwebacl-appsync]
|===
