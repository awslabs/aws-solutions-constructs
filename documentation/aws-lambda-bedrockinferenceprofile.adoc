...
Go to the https://github.com/awslabs/aws-solutions-constructs/tree/main/source/patterns/%40aws-solutions-constructs/aws-lambda-bedrockinferenceprofile[Github repo] for this pattern to view the code, read/create issues and pull requests and more.
