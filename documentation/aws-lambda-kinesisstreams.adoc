...
image::imagesws-lambda-kinesisstreams.png["Diagram showing the Lambda function, Kinesis data stream and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-lambda-kinesisstreams[-solutions-constructsaws-lambda-kinesisstreams]
|===
