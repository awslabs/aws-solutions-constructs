...
image::imagesws-fargate-dynamodb.png["Diagram showing the Fargate service, DynamoDB table, and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-fargate-dynamodb[-solutions-constructsaws-fargate-dynamodb]
|===
