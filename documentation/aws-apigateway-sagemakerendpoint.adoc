...
image::imagesws-apigateway-sagemakerendpoint.png["Diagram showing Amazon CloudWatch, API Gateway, SageMaker AI endpoint, and IAM roles connections.",scaledwidth=100%]
