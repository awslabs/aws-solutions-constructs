...
image::imagesws-apigateway-dynamodb.png["Diagram showing data flow from code to database, with security and cloud search components.",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-apigateway-dynamodb[-solutions-constructsaws-apigateway-dynamodb]
|===
