...
image::imagesws-sns-sqs.png["Diagram showing the SNS topic, and SQS queue and dlg created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-sns-sqs[-solutions-constructsaws-sns-sqs]
|===
