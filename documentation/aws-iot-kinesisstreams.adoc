...
image::imagesws-iot-kinesisstreams.png["Diagram showing the IoT rule, Kinesis data stream, CloudWatch alarm and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-iot-kinesisstreams[-solutions-constructsaws-iot-kinesisstreams]
|===
