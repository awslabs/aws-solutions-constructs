...
image::imagesws-eventbridge-sns.png["Diagram showing the EventBridge rule, SNS topic, and IAM role created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-eventbridge-sns[-solutions-constructsaws-eventbridge-sns]
|===
