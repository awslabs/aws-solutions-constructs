...
image::images/aws-lambda-comprehend.png["Diagram showing the Lambda function, Amazon Comprehend service, and IAM role created by the construct",scaledwidth=100%]

**Implementation when comprehendUseCases includes ComprehendUseCase.ASYNC_BATCH**

image::images/aws-lambda-comprehend-async.png["Diagram showing the Lambda function, source and destination S3 buckets, the Comprehend data access role, Amazon Comprehend service, and IAM roles created by the construct",scaledwidth=100%]
...
Go to the https://github.com/awslabs/aws-solutions-constructs/tree/main/source/patterns/%40aws-solutions-constructs/aws-lambda-comprehend[Github repo] for this pattern to view the code, read/create issues and pull requests and more.
