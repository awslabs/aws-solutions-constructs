...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-kinesisstreams-lambda[-solutions-constructsaws-kinesisstreams-lambda]
|===
