...
image::imagesws-kinesisstreams-lambda.png["Diagram showing the Kinesis data stream, CloudWatch log group, Lambda function and IAM role created by the construct",scaledwidth=100%]
