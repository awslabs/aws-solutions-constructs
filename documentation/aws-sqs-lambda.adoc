...
image::imagesws-sqs-lambda.png["Diagram showing the SQS queue, Lambda Function, CloudWatch log group and IAM role created by the construct",scaledwidth=100%]
