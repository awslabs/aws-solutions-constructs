...
image::imagesws-lambda-sagemakerendpoint.png["Diagram showing the Lambda function, SageMaker endpoint, CloudWatch log group and IAM roles created by the construct",scaledwidth=100%]
