...
image::imagesws-iot-kinesisfirehose-s3.png["Diagram showing the IOT rule, Kinesis data firehose, S3 buckets, log group and IAM roles created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-iot-kinesisfirehose-s3[-solutions-constructsaws-iot-kinesisfirehose-s3]
|===
