...
image::imagesws-openapigateway-lambda.png["Diagram showing the OpenAPI defnition, API Gateway api and Lambda functions created by the construct",scaledwidth=100%]
...
|https://github.com/awslabs/aws-solutions-constructs/tree/master/source/patterns/%40aws-solutions-constructs/aws-aws-openapigateway-lambda[-solutions-constructsaws-openapigateway-lambda]
|===
